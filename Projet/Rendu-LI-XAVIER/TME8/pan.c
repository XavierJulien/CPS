...
short src_ln0 [] = {
	  0,  11,  11,  12,  13,  14,  16,  19, 
	 19,  20,  22,  22,  23,  23,  24,  24, 
	 21,  26,  18,  27,  17,  28,  17,  28, 
	 28,  29,  15,  32,  15,  10,  33,  35, 
	 34,  37,  34,  37,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "feu.pml", 1, 35 },
...
{	/* int i; */
	printf("global vars:\n");
	printf("	mtype  vert:	5\n");
	printf("	mtype  orange:	4\n");
	printf("	mtype  orangeclignotant:	3\n");
	printf("	mtype  rouge:	2\n");
	printf("	mtype  rien:	1\n");
	printf("	mtype  initial:	8\n");
	printf("	mtype  normal:	7\n");
	printf("	mtype  enpanne:	6\n");
	printf("	mtype  oui:	10\n");
	printf("	mtype  non:	9\n");
	printf("	mtype  etatfeu:	%d\n", now.etatfeu);
	printf("	mtype  panne:	%d\n", now.panne);
	printf("	mtype  coulfeu:	%d\n", now.coulfeu);
}
void
...
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("rien"); return;
	case 2: Printf("rouge"); return;
	case 3: Printf("orangeclignotant"); return;
	case 4: Printf("orange"); return;
	case 5: Printf("vert"); return;
	case 6: Printf("enpanne"); return;
	case 7: Printf("normal"); return;
	case 8: Printf("initial"); return;
	case 9: Printf("non"); return;
	case 10: Printf("oui"); return;
