...
#define _nstates2	3	/* :init: */
#define minseq2	42
#define maxseq2	43
#define _endstate2	2

#define _nstates1	8	/* ispanne */
#define minseq1	35
#define maxseq1	41
#define _endstate1	7

#define _nstates0	36	/* feu */
#define minseq0	0
#define maxseq0	34
...
#define Pispanne	((P1 *)this)
typedef struct P1 { /* ispanne */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
